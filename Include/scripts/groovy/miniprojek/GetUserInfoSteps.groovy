...
class GetUserInfoSteps {
	...
	def getUserInfo() {
		...
		statusCode = WS.sendRequest(findTestObject('Request/Authentication/Get user information', [('BASE_URL') : GlobalVariable.BASE_URL]))
	...
	def postUserinfo() {
		...
		statusCode = WS.sendRequest(findTestObject('Request/Authentication/Post_Get user information'))
	...
	def putUserInfo() {
		...
		statusCode = WS.sendRequest(findTestObject('Request/Authentication/Put_Get user information'))
	}
	...
	def deleteUserInfo() {
		println("\n I inside put call user info")
		statusCode = WS.sendRequest(findTestObject('Request/Authentication/Delete_Get user information'))
