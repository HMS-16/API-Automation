...
class RegisterSteps {
	...
	defsetEndpoint() {
		statusCode = WS.sendRequest(findTestObject('Request/Authentication/Register', [('BASE_URL') : GlobalVariable.BASE_URL]))
	}
	...
	def setBodyRegisterEmpty() {
		statusCode = WS.sendRequest(findTestObject('Request/Authentication/Register - Empty data'))
	}
