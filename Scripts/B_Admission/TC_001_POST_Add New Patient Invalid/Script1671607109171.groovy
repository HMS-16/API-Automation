...
def response = WS.sendRequest(findTestObject('B_Admisson/REQ_04_Add New Patient_Website - Invalid', [('token') : GlobalVariable.tokenAdminWeb
...
def datafile = findTestData('Data Files/B_Admission/Add Patient Data_Invalid')
